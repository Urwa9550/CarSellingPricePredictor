"""
Django settings for CarPricePredictor project.
...
SECRET_KEY = "django-insecure-r(msw2r9*^j-a$1x03a0q#4cd2wq^k4wa8_(7(k)*v*=^fm)xr"
...
ALLOWED_HOSTS = ['carpricepred01-cc5cfb02a840.herokuapp.com', '127.0.0.1', 'localhost']
...
INSTALLED_APPS = [
    ...
    # "django.contrib.sessions", #cw mosh : we dont use sessions anymore
